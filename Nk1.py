...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://chat.whatsapp.com/KDC4VPajt6WKGhs49fSYtB")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("SMSBOMB was created by Nurakkkash Kotal")
...
__CONTRIBUTORS__ = ['Nurakkash Kotal']
...
parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Nurakkkash Kotal!!!')
